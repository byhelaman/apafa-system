          ...
          if (props.name === "months") {
            ...
            return (
              <Select onValueChange={(newValue) => {
                ...
                <SelectTrigger className="capitalize">{format(currentMonth, "MMM", { locale: es })}</SelectTrigger>
                <SelectContent className="capitalize h-60">
            ...
            const lastedYear = toYear || toMonth?.getFullYear() || toDate?.getFullYear()

            let selectItems: { label: string, value: string }[] = []

            if (earliestYear && lastedYear) {
              const yearsLength = lastedYear - earliestYear + 1
